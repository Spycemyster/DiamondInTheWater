...
namespace DiamondInTheWater.Entities
{
    public class Truck : Sprite
    {
        ...
        public Truck(Rectangle bounds, Random rand)
        {
        ...
        {
            right = Content.Load<Texture2D>("TruckRight");
            left = Content.Load<Texture2D>("TruckLeft");
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, new Rectangle((int)Position.X, (int)Position.Y, 57, 36), Color.White);
        }
